/* $Id$ */
/** @file
 * XPCOM - Common stuff for xptcinvoke/xptcstubs for riscv64.
 */
...
*********************************************************************************************************************************/
#ifndef VBOX_INCLUDED_SRC_unix_xptc_riscv64_vbox_h
#define VBOX_INCLUDED_SRC_unix_xptc_riscv64_vbox_h
...
#define NUM_ARGS_IN_GPRS    8          /**< Number of arguments passed in general purpose registers (starting with x10). */
...
#endif /* !VBOX_INCLUDED_SRC_unix_xptc_riscv64_vbox_h */
