/* $Id$ */
/** @file
 * CPUM - CPU Monitor(/Manager) - Getters and Setters, RISC-V variant.
 */
...
{
    RT_NOREF(pVM);
    return kCpumArch_RiscV; /* Static as we are in the RISC-V VMM module here. */
}
