...
typedef enum DBGFREG
{
    ...
    /** @name RISC-V register identifiers.
     * @{ */
    DBGFREG_RISCV_FIRST,
    /* General purpose registers: */
    DBGFREG_RISCV_GREG_X0 = DBGFREG_RISCV_FIRST,
    DBGFREG_RISCV_GREG_X1,
    DBGFREG_RISCV_GREG_X2,
    DBGFREG_RISCV_GREG_X3,
    DBGFREG_RISCV_GREG_X4,
    DBGFREG_RISCV_GREG_X5,
    DBGFREG_RISCV_GREG_X6,
    DBGFREG_RISCV_GREG_X7,
    DBGFREG_RISCV_GREG_X8,
    DBGFREG_RISCV_GREG_X9,
    DBGFREG_RISCV_GREG_X10,
    DBGFREG_RISCV_GREG_X11,
    DBGFREG_RISCV_GREG_X12,
    DBGFREG_RISCV_GREG_X13,
    DBGFREG_RISCV_GREG_X14,
    DBGFREG_RISCV_GREG_X15,
    DBGFREG_RISCV_GREG_X16,
    DBGFREG_RISCV_GREG_X17,
    DBGFREG_RISCV_GREG_X18,
    DBGFREG_RISCV_GREG_X19,
    DBGFREG_RISCV_GREG_X20,
    DBGFREG_RISCV_GREG_X21,
    DBGFREG_RISCV_GREG_X22,
    DBGFREG_RISCV_GREG_X23,
    DBGFREG_RISCV_GREG_X24,
    DBGFREG_RISCV_GREG_X25,
    DBGFREG_RISCV_GREG_X26,
    DBGFREG_RISCV_GREG_X27,
    DBGFREG_RISCV_GREG_X28,
    DBGFREG_RISCV_GREG_X29,
    DBGFREG_RISCV_GREG_X30,
    DBGFREG_RISCV_GREG_X31,

    DBGFREG_RISCV_PC,
    DBGFREG_RISCV_LAST = DBGFREG_RISCV_PC,
    /** @} */
