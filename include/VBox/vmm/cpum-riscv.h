...
#ifndef VBOX_INCLUDED_vmm_cpum_riscv_h
#define VBOX_INCLUDED_vmm_cpum_riscv_h
...
/** @defgroup grp_cpum_riscv      The CPU Monitor / Manager API
 * @ingroup grp_vmm
 * @{
 */
...
#ifdef IN_RING3
/** @defgroup grp_cpum_riscv_r3    The CPUM RISC-V ring-3 API
 * @{
 */
